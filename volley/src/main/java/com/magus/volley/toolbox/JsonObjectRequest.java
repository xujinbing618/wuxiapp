...
import com.magus.volley.ParseError;
...
public class JsonObjectRequest extends JsonRequest<JSONObject> {
    ...
    protected Response<JSONObject> parseNetworkResponse(NetworkResponse response) {
        try {
            // 通过这个方法获得数据的编码格式 HttpHeaderParser.parseCharset(response.headers)
            //强制将编码格式转为utf-8
//            Log.e(TAG,HttpHeaderParser.parseCharset(response.headers));
            String jsonString =
