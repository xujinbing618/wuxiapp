 ...
 * 2015-15/4/16-下午5:03.
 */
public class WorkCheckedFragment extends BaseFragment {
    ...
    private String[] strs={"已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查","已检查"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (mRootView==null){
            mRootView = inflater.inflate(R.layout.fragment_work_checked,null);
