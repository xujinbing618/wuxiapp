...
public class CaseFileAdapter extends BaseAdapter{
    ...
    private List<CaseBean> mList;
    private LayoutInflater mLayoutInflater;
    private Context mContext;
    private ProgressDialog mProgressDialog;

    public CaseFileAdapter(Context context, List<CaseBean> list) {
        this.mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final CaseBean caseBean = mList.get(position);
        String[] names = caseBean.getFileUrl().split("/");
        ...
        holder.pdfName.setText(caseBean.getFileName());
        ...
        holder.pdfDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isFileExists) {
                    ...
                    MyDownload myDownload = new MyDownload(caseBean.getFileUrl(), new MyDownloadHandler() {
                        @Override
