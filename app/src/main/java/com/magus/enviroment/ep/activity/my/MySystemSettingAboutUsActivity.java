 ...
 * 关于我们
 */
public class MySystemSettingAboutUsActivity extends SwipeBackActivity {
   ...
   // private TextView my_system_settings_about_us_txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MyApplication myApplication = (MyApplication) MySystemSettingAboutUsActivity.this.getApplication();
        version.setText(myApplication.getVersionName());
    ...
    private void initActionBar() {
        ...
        mActionBar.setLeftImageClickListener(MySystemSettingAboutUsActivity.this);
    }
